...
function NewsletterForm() {
  ...
  const [successMessage, setSuccessMessage] =
    React.useState<MembersSuccessResponse>();
  ...
  return (
    <div className="flex flex-col space-y-8 md:w-[400px]">
      ...
      >
        ...
        >
          <EnvelopeIcon
            className="hidden sm:inline w-6 h-6 text-[#4B4C52] group-focus-within:text-white 
          ...
          <input
            ...
            group-focus-within:placeholder-white bg-transparent placeholder:transition-colors 
      ...
      <div className="relative">
        {(successMessage || errorMessage) && (
          <div className="flex items-start space-x-2 bg-[#0A0E12] 
          shadow-outline-gray text-white rounded-[9px] py-4 px-6 animate-fade-bottom 
          absolute">
